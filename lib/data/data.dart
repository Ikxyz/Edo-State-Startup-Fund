...
List<StartupClass> generateStartupData() {
  return [
    StartupClass(
      name: "Hikers get killed by bears",
      category: "hiking",
      image: [], 
      desc:
    ...
    StartupClass(
      name: "This town is absolutely something else",
      category: "killing",
       image: [],  
      desc:
          "amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel",
    ...
    StartupClass(
      name: "Ghost torments citizens of this City",
      category: "music",
      image: [], 
      desc:
          "amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate vel",
